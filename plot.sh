...
do
    ...
    gnuplot -e "phase=${ITERATION}" window-fixed.gp
    ...
    gnuplot -e "phase=${ITERATION}" loss-fixed.gp
    ...
    gnuplot -e "phase=${ITERATION}" latency-fixed.gp
...
python3 window.py $OFFSET $STEP $2
...
python3 latency.py $OFFSET $STEP $2
